        ...
        <article class="card pull-right admin-form">
            <div id="safaris">
                <h4 class="clearfix desktop">
                    ...
                    <a href="{{ route('car-price-create') }}" class="pull-right heading">
                        Add Price Type
                    </a>
                </h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="manage-safari pull-right">
                                    <a href="{{ route('vehicle-transfer-edit', $priceType) }}">
                                        <i class="lni-pencil-alt"></i>
                                        Edit
                                    </a>

                                    <a onclick="confirm('Are you sure to delete this make?') ? document.getElementById('delete-form-{{ $priceType->id }}').submit() : NaN">
                                        <i class="lni-pencil-alt"></i>
                                        Delete
                                    </a>
