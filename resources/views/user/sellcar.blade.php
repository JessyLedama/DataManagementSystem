        ...
        <div class="col-md-8">
          <div class="sellCar-form mb-5 p-4 bg-white pt-5">
            <form method="POST" action="{{ route('sell-car-store') }}" enctype="multipart/form-data">
              	...
              	<div class="row">
              		...
              		<div class="col-md-6">
						...
						<div class="mb-4">
							...
							<select class="form-control select2" name="priceType" required>
								<option>Select Price Type</option>
								@foreach ($carPriceTypes as $carPriceType)
									<option value="{{ $carPriceType->id }}" {{ $carPriceType->id == old('conditionId') ? 'selected' : ''}}>
											{{ ucwords($carPriceType->name) }}
									</option>
								@endforeach
							</select>
						...
						<div class="mb-4">
							...
							<select class="form-control select2" name="transmissionId" required>
								<option>Select</option>
								@foreach ($transmissionIds as $transmission)
									<option value="{{ $transmission->id }}" {{ $transmission->id == old('conditionId') ? 'selected' : ''}}>
											{{ ucwords($transmission->name) }}
									</option>
								@endforeach
							</select>
				...
				<label class="pb-2">Features</label>
              	...
              	<div class="row fearturs">
              		...
              		<div class="col-md-4">
              			...
              			<div class="mb-3">
              				<input type="checkbox" name="features" class="form-check-input" id="ABS" value="ABS">
                   			<label class="form-check-label" for="ABS">ABS</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="features" class="form-check-input" id="Alloy" value="Alloy Rims">
                   			<label class="form-check-label" for="Alloy">Alloy Rims</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="features" class="form-check-input" id="CD">
                   			<label class="form-check-label" for="CD">CD Player</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="features" class="form-check-input" id="DVD">
                   			<label class="form-check-label" for="DVD">DVD Player</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="features" class="form-check-input" id="Power">
                   			<label class="form-check-label" for="Power">Power Locks</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="features" class="form-check-input" id="PowerWindows">
				...
				<div class="mb-4">
              	...
              	<div class="row">
              		...
              		<div class="col-md-6">
		                  ...
		                  <input type="text" name="sellerId" class="form-control" value="{{ Auth::user()->name }}">
		                </div>
              		</div>
                ...
                <div class="mb-4 pb-4">
                  <button class="post-add" type="submit">CONTINUE</button>
                </div>
            </form>
          </div>
        </div>
