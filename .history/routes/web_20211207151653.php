...
Route::prefix('admin')->group(function()
{
    ...
    //Products
    Route::get('/products', [CarMakeController::class, 'index'])->middleware('auth')->name('products-list');

    Route::get('/create-car-makes', [CarMakeController::class, 'create'])->middleware('auth')->name('products-create');

    Route::post('/store-car-makes', [CarMakeController::class, 'store'])->middleware('auth')->name('products-store');
