...
Route::prefix('admin')->group(function()
{
    ...
    //Categories
    Route::get('/categories', [CategoriesController::class, 'index'])->middleware('auth')->name('categories-list');

    Route::get('/create-categories', [CategoriesController::class, 'create'])->middleware('auth')->name('categories-create');

    Route::post('/store-categories', [CategoriesController::class, 'store'])->middleware('auth')->name('categories-store');
