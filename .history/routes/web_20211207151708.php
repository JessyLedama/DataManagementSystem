...
Route::prefix('admin')->group(function()
{
    ...
    Route::get('/create-products', [CarMakeController::class, 'create'])->middleware('auth')->name('products-create');

    Route::post('/store-products', [CarMakeController::class, 'store'])->middleware('auth')->name('products-store');
