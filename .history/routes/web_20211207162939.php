...
Route::prefix('admin')->group(function()
{
    ...
    //Categories
    Route::get('/categories', [CategorController::class, 'index'])->middleware('auth')->name('categories-list');

    Route::get('/create-categories', [CategorController::class, 'create'])->middleware('auth')->name('categories-create');

    Route::post('/store-categories', [CategorController::class, 'store'])->middleware('auth')->name('categories-store');
