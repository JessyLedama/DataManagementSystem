...
Route::prefix('admin')->group(function()
{
    ...
    Route::get('/create-categories', [CarModelController::class, 'create'])->middleware('auth')->name('categories-create');

    Route::post('/store-categories', [CarModelController::class, 'store'])->middleware('auth')->name('categories-store');
