...
use App\Http\Controllers\CoverTypesController;
use App\Http\Controllers\CarInsuranceController;
use App\Http\Controllers\Admin\AdminController;
use App\Http\Controllers\VehicleTransferController;
use App\Http\Controllers\LogbookCarSearchController;
use App\Http\Controllers\MileageVerificationController;
...
|--------------------------------------------------------------------------
|
| Web routes for your CARBAZAAR. These
...
Route::prefix('admin')->group(function()
{
    ...
    //Car makes
    Route::get('/car-makes', [CarMakeController::class, 'index'])->middleware('auth')->name('car-makes-list');
