...
Route::prefix('admin')->group(function()
{
    ...
    //Categories
    Route::get('/categories', [CarModelController::class, 'index'])->middleware('auth')->name('categoriess-list');

    Route::get('/create-car-models', [CarModelController::class, 'create'])->middleware('auth')->name('categoriess-create');

    Route::post('/store-car-models', [CarModelController::class, 'store'])->middleware('auth')->name('categoriess-store');
