...
Route::prefix('admin')->group(function()
{
    ...
    //Categories
    Route::get('/categories', [CarModelController::class, 'index'])->middleware('auth')->name('categories-list');

    Route::get('/create-car-models', [CarModelController::class, 'create'])->middleware('auth')->name('categories-create');

    Route::post('/store-car-models', [CarModelController::class, 'store'])->middleware('auth')->name('categories-store');
