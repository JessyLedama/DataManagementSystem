    ...
    <section class="clearfix">
        ...
        <article class="card pull-right">
            <div id="safaris">
                ...
                @foreach ($logbookCarSearches as $logbookCarSearch)
                    <div class="safari clearfix">
                        <div class="pull-left">
                            {{ ucwords($logbookCarSearch->current_owner) }}
                        </div>

                        <div class="manage-safari pull-right">
                            <a href="{{ route('edit-user', $logbookCarSearch) }}">
                                <i class="lni-pencil-alt"></i>
                                Edit
                            </a>

                            <a onclick="confirm('Are you sure to delete this request?') ? document.getElementById('delete-form-{{ $logbookCarSearch->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>

                            <form id="delete-form-{{ $logbookCarSearch->id }}" action="{{ route('delete-user', $logbookCarSearch) }}" method="post">
