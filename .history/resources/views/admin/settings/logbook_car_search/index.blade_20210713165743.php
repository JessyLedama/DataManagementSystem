    ...
    <section class="clearfix">
        ...
        <article class="card pull-right">
            <div id="safaris">
                ...
                @foreach ($logbookCarSearches as $logbookCarSearche)
                    <div class="safari clearfix">
                        <div class="pull-left">
                            {{ ucwords($logbookCarSearche->current_owner) }}
                        </div>

                        <div class="manage-safari pull-right">
                            <a href="{{ route('edit-user', $logbookCarSearche) }}">
                                <i class="lni-pencil-alt"></i>
                                Edit
                            </a>

                            <a onclick="confirm('Are you sure to delete this request?') ? document.getElementById('delete-form-{{ $logbookCarSearche->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>

                            <form id="delete-form-{{ $logbookCarSearche->id }}" action="{{ route('delete-user', $logbookCarSearche) }}" method="post">
