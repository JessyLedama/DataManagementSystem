        ...
        <article class="card pull-right">
            <div id="safaris">
                ...
                <table class="table">
                    ...
                    @foreach ($logbookCarSearches as $logboo)
                    <tbody>
                        <tr>
                            <td scope="row">
                                {{ ucwords($logboo->name) }}
                            ...
                            <td>
                                {{ ucwords($logboo->phone) }}
                            </td>
                            
                            <td>
                                {{ ucwords($logboo->registration_no) }}
                            </td>

                            <td>
                                <div class="manage-safari pull-right">
                                    <a href="{{ route('vehicle-transfer-edit', $logboo) }}">
                                        <i class="lni-pencil-alt"></i>
                                        Edit
                                    </a>

                                    <a onclick="confirm('Are you sure to delete this request?') ? document.getElementById('delete-form-{{ $logboo->id }}').submit() : NaN">
                                        <i class="lni-pencil-alt"></i>
                                        Delete
                                    </a>

                                    <form id="delete-form-{{ $logboo->id }}" action="{{ route('delete-user', $logboo) }}" method="post">
