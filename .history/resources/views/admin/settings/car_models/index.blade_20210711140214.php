        ...
        <article class="card pull-right">
            <div id="safaris">
                <h4 class="clearfix desktop">
                    ...
                    <a href="{{ route('create-car-model') }}" class="pull-right">
                        Add Car Models
                    </a>
                </h4>
                ...
                <div class="clearfix mobile">
                    <h4>
                        <a href="{{ route('car-models') }}" id="back-to-menu">
                ...
                @foreach ($carModels as $carModel)
                    <div class="safari clearfix">
                        ...
                        <div class="manage-safari pull-right">
                            <a href="{{ route('edit-user', $carModel) }}">
                                <i class="lni-pencil-alt"></i>
                                Edit
                            </a>

                            <a onclick="confirm('Are you sure to delete this carModel') ? document.getElementById('delete-form-{{ $carModel->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>
