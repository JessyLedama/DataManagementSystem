    ...
    <section class="clearfix">
        ...
        <article class="card pull-right">
            <div id="safaris">
                ...
                @foreach ($engineTys as $engineTy)
                    <div class="safari clearfix">
                        <div class="pull-left">
                            {{ ucwords($engineTy->name) }}
                        </div>

                        <div class="manage-safari pull-right">
                            <a href="{{ route('edit-user', $engineTy) }}">
                                <i class="lni-pencil-alt"></i>
                                Edit
                            </a>

                            <a onclick="confirm('Are you sure to delete this engineTy') ? document.getElementById('delete-form-{{ $engineTy->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>

                            <form id="delete-form-{{ $engineTy->id }}" action="{{ route('delete-user', $engineTy) }}" method="post">
