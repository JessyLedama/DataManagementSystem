                ...
                @foreach ($cities as $ci)
                    <div class="safari clearfix">
                        ...
                        <div class="manage-safari pull-right">
                            <a href="{{ route('edit-user', $ci) }}">
                                <i class="lni-pencil-alt"></i>
                                Edit
                            </a>

                            <a onclick="confirm('Are you sure to delete this ci') ? document.getElementById('delete-form-{{ $ci->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>

                            <form id="delete-form-{{ $ci->id }}" action="{{ route('delete-user', $ci) }}" method="post">
