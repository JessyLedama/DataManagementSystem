                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="manage-safari pull-right">
                                    <a href="{{ route('car-engine-types-edit', $car) }}">
                                        <i class="lni-pencil-alt"></i>
                                        Edit
                                    </a>

                                    <a onclick="confirm('Are you sure to delete this engine size?') ? document.getElementById('delete-form-{{ $car->id }}').submit() : NaN">
                                        <i class="lni-pencil-alt"></i>
                                        Delete
                                    </a>

                                    <form id="delete-form-{{ $car->id }}" action="{{ route('delete-user', $car) }}" method="post">
