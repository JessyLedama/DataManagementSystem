        ...
        <article class="card pull-right admin-form">
            <div id="safaris">
                ...
                <table class="table">
                    ...
                    @foreach ($engineSizes as $engineS)
                    <tbody>
                        <tr>
                            <td scope="row">
                                {{ ucwords($engineS->name) }}
                            </td>

                            <td>
                                <div class="manage-safari pull-right">
                                    <a href="{{ route('car-engine-types-edit', $engineS) }}">
                                        <i class="lni-pencil-alt"></i>
                                        Edit
                                    </a>

                                    <a onclick="confirm('Are you sure to delete this car body?') ? document.getElementById('delete-form-{{ $engineS->id }}').submit() : NaN">
                                        <i class="lni-pencil-alt"></i>
                                        Delete
                                    </a>

                                    <form id="delete-form-{{ $engineS->id }}" action="{{ route('delete-user', $engineS) }}" method="post">
