                ...
                @foreach ($carPriceTypes as $priceType)
                    <div class="safari clearfix">
                        ...
                        <div class="manage-safari pull-right">
                            <a href="{{ route('edit-user', $priceType) }}">
                                <i class="lni-pencil-alt"></i>
                                Edit
                            </a>

                            <a onclick="confirm('Are you sure to delete this price$priceType') ? document.getElementById('delete-form-{{ $priceType->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>
