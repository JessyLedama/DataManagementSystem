    ...
    <section class="clearfix">
        ...
        <article class="card pull-right">
            <div id="safaris">
                ...
                @foreach ($vehicleTransferRequests as $vehicleTransferRequest)
                    <div class="safari clearfix">
                        ...
                        <div class="manage-safari pull-right">
                            ...
                            <a onclick="confirm('Are you sure to delete this city') ? document.getElementById('delete-form-{{ $vehicleTransferRequest->id }}').submit() : NaN">
                                <i class="lni-pencil-alt"></i>
                                Delete
                            </a>
                ...
                {{ $newOwner }} {{ $selectVehicle }} {{ $transfer }}
