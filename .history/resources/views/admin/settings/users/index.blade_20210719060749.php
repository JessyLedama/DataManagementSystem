                        ...
                        <tr>
                            ...
                            <td>
                                <div class="manage-safari pull-right">
                                    ...
                                    <a href="{{ route('activate-user', $user) }}">
                                        <i class="lni-pencil-alt"></i>
                                        Activate
                                    </a>
                            ...
                            <td>
                                <div class="manage-safari pull-right">
                                    <a href="{{ route('vehicle-transfer-edit', $carBody) }}">
                                        <i class="lni-pencil-alt"></i>
                                        Edit
                                    </a>

                                    <a onclick="confirm('Are you sure to delete this car body?') ? document.getElementById('delete-form-{{ $carBody->id }}').submit() : NaN">
                                        <i class="lni-pencil-alt"></i>
                                        Activate
                                    </a>

                                    <form id="delete-form-{{ $carBody->id }}" action="{{ route('delete-user', $carBody) }}" method="post">
