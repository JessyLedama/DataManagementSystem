                        ...
                        <tr>
                            ...
                            <td>
                                <div class="manage-safari pull-right">
                                    ...
                                    <a onclick="confirm('Are you sure to delete this car color?') ? document.getElementById('delete-form-{{ $cover->id }}').submit() : NaN">
                                        <i class="lni-pencil-alt"></i>
                                        Delete
                                    </a>

                                    <form id="delete-form-{{ $cover->id }}" action="{{ route('delete-user', $city) }}" method="post">
