      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('sell-car') }}" class="nav-link btn btn-success" style="color: white; text-transform: uppercase;">Sell yor caur</a>
          </li>
        </ul>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <!-- CAR MAKES -->
                  <li class="nav-item">
                    <a href="{{ route('car-makes-list') }}" class="nav-link">
                      <i class="nav-icon fas fa-chevron-right"></i>
                      <p>
                        All Car Makes
                      </p>
                  ...
                  <li class="nav-item">
                    <a href="{{ route('car-makes-create') }}" class="nav-link">
                      <i class="nav-icon fas fa-chevron-right"></i>
                      <p>
                        Add Car Makes
                      </p>
