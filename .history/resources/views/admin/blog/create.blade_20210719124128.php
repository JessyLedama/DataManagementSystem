                 ...
                 <div class="col-md-6">
                   <div class="mb-3">
                     <div class="mb-3">
                       ...
                       <label for="title" class="form-label" :value="__('Name')">Title</label>
                       
                       <input type="text" name="title" placeholder="Car Color" class="form-control" id="title" :value="old('title')" required autofocus>
                     </div>
                   </div>
                 </div>
               </div>
