                 ...
                 <div class="col-md-6">
                   <div class="mb-3">
                     <div class="mb-3">
                       ...
                       <input type="text" name="image" placeholder="Product Image" class="form-control" id="image" :value="old('image')" required autofocus>

                       <label for="category" class="form-label" :value="__('Category')">Category</label>
                       
                       <input type="text" name="category" placeholder="Category" class="form-control" id="category" :value="old('category')" required autofocus>
                     </div>
                   </div>
                 </div>
               </div>
