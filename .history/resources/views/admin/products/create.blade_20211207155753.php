                 ...
                 <div class="col-md-6">
                   <div class="mb-3">
                     <div class="mb-3">
                       ...
                       <label for="details" class="form-label" :value="__('Category')">Category</label>
                       
                       <input type="text" name="categoryId" placeholder="Category" class="form-control" id="details" :value="old('details')" required autofocus>
