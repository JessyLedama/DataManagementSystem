...
<!-- jQuery UI 1.11.4 -->
<script src="{{ assetplugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- ChartJS -->
<script src="{{ assetplugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="{{ assetplugins/jqvmap/jquery.vmap.min.js"></script>
<script src="{{ assetplugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="{{ assetplugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="{{ assetplugins/moment/moment.min.js"></script>
<script src="{{ assetplugins/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ assetplugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="{{ assetplugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="{{ assetplugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
