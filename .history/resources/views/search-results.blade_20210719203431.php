	...
	<div class="container">
	  <div class="row">
	    <div class="col-md-12">
	      ...
	      <h3>Search Results {{ $results[name] }}</h3>
	    </div>
	  </div>
	</div>
</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="car-top-bar-left">
								<h3>Found Ads <span>({{ $resultsCount }})</span></h3>
							</div>
						</div>
				...
				<div class="search-car-content">
					...
					<div class="search-car-topbar filter-for-pc">
						<div class="row">
							<div class="col-md-6">
								<div class="car-top-bar-left">
									<h3>Results Found <span>({{ $resultsCount }})</span></h3>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="featured-item">
						    		<div class="f-image">
                                        ...
                                        <div class="price-tag">
                                            <span>Kshs. <span style="font-size: 14px;font-weight: 400">()</span></span>
                                        </div>
							    	</div>
                                    ...
                                    <div class="featured-content">
                                        <div class="category-title">
                                            ...
                                            <a href="#" class="padding-cats txt-hover"></a>
                                        </div>
                                        
                                        <div class="featured-desc">
                                            <h3>
                                                <a class="txt-hover" href="#"></a>
                                            </h3>
                                            <p class="location">
									...
									<div class="featured-footer">
						    			<p><i class="flaticon-calendar"></i> <span></span></p>
						    			<ul>
