            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="myForm login-form mb-5">
                        ...
                        @csrf
                        <div class="mb-5">
                            <label class="form-label" for="phone_verification" :value="__('Verification PHone')">Email or Phone</label>
                            <input type="text" placeholder="Your Email or Phone" class="form-control" id="phone_verification" name="phone_verification" :value="{{ old('phone_verification') ?: old('phone_verification')}}" required autofocus>
                        </div>
