				...
				<div class="myForm login-form mb-5">
                    ...
                    <form method="POST" action="{{ route('login') }}">
					  <div class="mb-5">
					    ...
					    <input type="email" placeholder="Your Email" class="form-control" id="email" name="email" :value="old('email')" required autofocus>
					  </div>
					  
                      <div class="mb-3">
					    <label class="form-label" for="password" :value="__('password')">Password</label>
					    <input type="password" placeholder="Your Password" class="form-control" id="password" type="email" name="email" :value="old('email')" required autofocus>
					  </div>
                    ...
                    <p class="text-center pt-4 mb-0"><a href="#">Sign up for an account.</a></p>
				</div>
			</div>
		</div>
	</div>
