                ...
                <div class="col-md-12">
                    <div class="myForm login-form mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" placeholder="Enter verification" class="form-control" id="phone_verification" name="phone_verification" :value="{{ old('phone_verification') ?: old('phone_verification')}}" required autofocus>
                        </div>
