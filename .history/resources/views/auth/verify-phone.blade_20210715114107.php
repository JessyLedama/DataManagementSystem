            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="myForm login-form mb-5">
                        ...
                        @csrf
                        <div class="mb-5">
                            <label class="form-label" for="phone" :value="__('Verification PHone')">Email or Phone</label>
                            <input type="text" placeholder="Your Email or Phone" class="form-control" id="phone" name="phone" :value="{{ old('phone') ?: old('phone')}}" required autofocus>
                        </div>
