            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="myForm login-form mb-5">
                        ...
                        <!-- Validation Errors -->
                        <x-auth-validation-errors class="mb-4 alert-warning " :errors="$errors" />
                        ...
                        <div class="mb-5">
                            <label class="form-label {{ $errors->has('phone') ? 'has-error' : '' }}" for="email" :value="__('Email or  Phone')">Email or Phone</label>
