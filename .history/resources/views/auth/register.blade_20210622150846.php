      ...
      <div class="row">
        <div class="col-md-12">
          <div class="login-form myForm register-form mb-5">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    <div class="mb-3">
                      ...
                      <input type="text" placeholder="Your Name" class="form-control" id="name" :value="old('name')" required autofocus>
                    </div>
                    
                    <label for="email" class="form-label" :value="__('Email')">Email</label>
                    <input type="email" placeholder="Your Email" class="form-control" id="email" :value="old('email')" required>
                  </div>
                </div>
                
                <div class="col-md-6">
                  <div class="mb-3">
                    <label for="phone" class="form-label" :value="__('Email')">Contact Number</label>
                    <input type="text" placeholder="Your Contact Number" class="form-control" id="number" :value="old('phone')" required>
                  </div>
                  
                  <div class="mb-3">
                    <label for="password" class="form-label">Password</label>
                    <input type="password" placeholder="Your Password" class="form-control" id="password" :value="old('password')" required>
                  </div>
                </div>
              </div>
            ...
            <p class="text-center pt-4 mb-0"><a href="login.php">Already registered? Log in here</a></p>
          </div>
        </div>
      </div>
    </div>
