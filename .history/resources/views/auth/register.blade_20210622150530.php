              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="email" placeholder="Your Email" class="form-control" id="email" :value="old('email')" required autofocus>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                    <label for="number" class="form-label">Contact Number</label>
                    <input type="text" placeholder="Your Contact Number" class="form-control" id="number">
                  </div>
                  <div class="mb-3">
