          ...
          <div class="login-form myForm register-form mb-5">
            ...
            @csrf
              ...
              <div class="mb-3 form-check">
                <div class="row">
                  <div class="col-md-6">
                    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="acce" required>
                    <label class="form-check-label" for="exampleCheck1">I accept the <a>Terms and Conditions.</a> </label>
                  </div>
