				...
				<label class="pb-2">Features</label>
              	...
              	<div class="row fearturs">
              		...
              		<div class="col-md-4">
              			...
              			<div class="mb-3">
              				<input type="checkbox" name="feati" class="form-check-input" id="ABS">
                   			<label class="form-check-label" for="ABS">ABS</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="feati" class="form-check-input" id="Alloy">
                   			<label class="form-check-label" for="Alloy">Alloy Rims</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="feati" class="form-check-input" id="CD">
                   			<label class="form-check-label" for="CD">CD Player</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="feati" class="form-check-input" id="DVD">
                   			<label class="form-check-label" for="DVD">DVD Player</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="feati" class="form-check-input" id="Power">
                   			<label class="form-check-label" for="Power">Power Locks</label>
              			</div>

              			<div class="mb-3">
              				<input type="checkbox" name="feati" class="form-check-input" id="PowerWindows">
