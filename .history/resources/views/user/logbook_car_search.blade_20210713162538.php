                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <label for="phone" class="form-label" :value="__('Name')">Car Name</label>
                        
                        <input type="text" name="phone" placeholder="Car Name" class="form-control" id="phone" :value="old('phone')" required autofocus>
                      </div>
                    </div>
                  </div>
