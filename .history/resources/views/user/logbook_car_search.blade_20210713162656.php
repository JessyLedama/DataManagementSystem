                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <label for="name" class="form-label" :value="__('Registration')">Registration Number</label>
                        
                        <input type="text" name="name" placeholder="Registration Number" class="form-control" id="name" :value="old('name')" required autofocus>
                      </div>
                    </div>
                  </div>
