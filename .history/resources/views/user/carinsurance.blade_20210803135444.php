	...
	<div class="multi-step-form bg-light">
		<form id="msform" method="POST" action="{{ route('sell-insurance-store') }}">
			...
			<fieldset>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="vaicle-select">
							<input type="radio" checked="" name="vehicle_category" id="private" value="Private Vehicle">
							<label for="private">
					...
					<div class="col-md-4">
						<div class="vaicle-select">
							<input type="radio" name="vehicle_category" id="commercial" value="Commercial Vehicle">
					...
					<div class="col-md-4">
						<div class="vaicle-select">
							<input type="radio" name="vehicle_category" id="publicService" value="Public Service Vehicle">
				...
				<input type="text" id="phone-out" name="mobile" placeholder="+254 0722 123 456" />
			...
			<fieldset>
				...
				<select name="cover_type" required>
					...
					@foreach ($coverTypes as $cover)
						<option value="{{ $cover->id }}" {{ $cover->id == old('coverId') ? 'selected' : ''}}>
								{{ ucwords($cover->name) }}
						</option>
					@endforeach
				</select>
				...
				<input type="text" name="vehicle_value" placeholder="Vehicle Value" />
				<input type="text" name="vehicle_registration" placeholder="Registration" />
			...
			<fieldset>
				<table class="table table-striped border table-responsive">
					...
					<tbody>
						...
						<tr>
							<td>
								<input type="text" class="form-control" name="vehicle_registration" id="private-out" value="">
							</td>

							<td>3.6</td>

							<td>
								<input type="text" class="form-control" name="vehicle_registration" id="phone-out" value="">
							</td>
							<td>Ksh. 20,130</td>
							<td>
