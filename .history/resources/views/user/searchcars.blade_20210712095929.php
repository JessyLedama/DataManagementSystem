								...
								<div class="featured-item">
							    	...
							    	<div class="featured-content">
							    		...
							    		<div class="featured-desc">
							    			<h3><a class="txt-hover" href="#">{{ ucwords($car->name) }}</a></h3>
								    		<p class="location"><i class="flaticon-maps-and-flags"></i> <a class="txt-hover" href="#">{{ ucwords($car->selleraddress) }}</a></p>
								    		<ul>
