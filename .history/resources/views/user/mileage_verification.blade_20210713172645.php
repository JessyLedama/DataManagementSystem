       ...
       <div class="row">
         <div class="col-md-12">
           <div class="login-form myForm register-form mb-5">
             ...
             <form method="POST" action="{{ route('logbook-car-search-store') }}">
             @csrf
               <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <label for="registration_no" class="form-label" :value="__('Registration')">Car Chasis Number</label>
                        
                        <input type="text" name="registration_no" placeholder="Car Chasis Number" class="form-control" id="registration_no" :value="old('registration_no')" required>
                      </div>
                    </div>
                  </div>
               </div>
