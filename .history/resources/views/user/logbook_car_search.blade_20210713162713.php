                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <label for="registration" class="form-label" :value="__('Registration')">Registration Number</label>
                        
                        <input type="text" name="registration" placeholder="Registration Number" class="form-control" id="registration" :value="old('registration')" required autofocus>
                      </div>
                    </div>
                  </div>
