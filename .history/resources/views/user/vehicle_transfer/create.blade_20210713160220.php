             ...
             @csrf
               <div class="row">
                 <div class="col-md-6">
                    ...
                    <!-- Car Make --->
				    <div class="mb-4">
                        <label class="pb-2">Select Vehicle <br />
                            <span>Select vehicle to transfer  </span>
                        </label>
                        
                        <select class="form-control select2" name="select_product" required>
                            <option>Select</option>
                            @foreach ($vehicles as $vehicle)
                                <option value="{{ $vehicle->id }}" {{ $vehicle->id == old('select_product') ? 'selected' : ''}}>
