             ...
             @csrf
               <div class="row">
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="phone" class="form-label" :value="__('Phone')"Phoner</label>
                            
                            <input type="text" name="new_owner" placeholder="Phone" class="form-control" id="phone" :value="old('new_owner')" required autofocus>
                        </div>
                    </div>
                 </div>
