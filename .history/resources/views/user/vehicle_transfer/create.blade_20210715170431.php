             ...
             @csrf
               <div class="row">
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="transfer_type" class="form-label" :value="__('Type of Transfer')">Type of Tr</label>
                            
                            <input type="text" name="new_owner" placeholder="Type of Tr" class="form-control" id="transfer_type" :value="old('new_owner')" required autofocus>
                        </div>
                    </div>
                 </div>
