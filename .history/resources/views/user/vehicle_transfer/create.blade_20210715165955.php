             ...
             @csrf
               <div class="row">
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="email" class="form-label" :value="__('Email')">New Owner</label>
                            
                            <input type="text" name="new_owner" placeholder="New Owner" class="form-control" id="email" :value="old('new_owner')">
                        </div>
                    </div>
                 </div>
