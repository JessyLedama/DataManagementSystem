             ...
             @csrf
               <div class="row">
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="phone" class="form-label" :value="__('Phone')">New Owner</label>
                            
                            <input type="text" name="new_owner" placeholder="New Owner" class="form-control" id="phone" :value="old('new_owner')" required autofocus>
                        </div>
                    </div>
                 </div>
