             ...
             @csrf
               <div class="row">
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="transfer_type" placeholder="Type of Transfer" class="form-control" id="transfer_type" :value="old('transfer_type')" required autofocus>
                        </div>
                    </div>
                 </div>
                 ...
                 <div class="col-md-12">
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="vehicle_type" class="form-label" :value="__('Type of Vehicle')">Type of Vehi</label>
                            
                            <input type="text" name="new_owner" placeholder="Type of Vehi" class="form-control" id="vehicle_type" :value="old('new_owner')" required autofocus>
                        </div>
                    </div>
                 </div>
