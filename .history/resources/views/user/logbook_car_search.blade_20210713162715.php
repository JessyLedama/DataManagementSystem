                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <input type="text" name="registration_no" placeholder="Registration Number" class="form-control" id="registration_no" :value="old('registration_no')" required autofocus>
                      </div>
                    </div>
                  </div>
