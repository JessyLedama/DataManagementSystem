                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <label for="name" class="form-label" :value="__('Name')">You Name</label>
                        
                        <input type="text" name="name" placeholder="You Name" class="form-control" id="name" :value="old('name')" required autofocus>
                      </div>
                    </div>
                  </div>
