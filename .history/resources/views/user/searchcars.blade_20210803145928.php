					  ...
					  <div class="accordion-item">
					    ...
					    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
					      		<form method="POST" action="{{ route('keyword-search') }}">
									@csrf
									<div class="search-box">
										<input class="" placeholder="Search" type="text" name="keyword">
					      ...
					      <div class="accordion-body">
							  @foreach($cities as $city)
								<ul>
									@foreach($cities as $city)
										<li>
											<a href="#">{{ $city->name }} <span>(0)</span></a>
										</li>
									@endforeach
									...
									<li>
										<a href="#">Nakuru  <span>(25)</span></a>
									</li>

									<li>
										<a href="#">Rest of Kenya  <span>(99)</span></a>
									</li>
								</ul>
							  @endforeach
					      </div>
					    ...
					    <div id="collaps7" class="accordion-collapse collapse" aria-labelledby="heading7" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
						  	<form method="POST" action="{{ route('keyword-search') }}">
								...
								@csrf
								<label class="pb-2">Select Transmission</label><br>
							  
								<select name="makeId" required>
									<option>Select</option>
								  @foreach ($carTransmissions as $carTransmission)
									  
									  <option value="{{ $carTransmission->id }}" {{ $carTransmission->id == old('makeId') ? 'selected' : ''}}>
											  {{ ucwords($carTransmission->name) }}
									  </option>
								  @endforeach
							  </select>
					    ...
					    <div id="collaps8" class="accordion-collapse collapse" aria-labelledby="heading8" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
						  	<form method="POST" action="{{ route('keyword-search') }}">
								...
								@csrf
								<label class="pb-2">Select Engine Type</label><br>
							  
								<select name="makeId" required>
									<option>Select</option>
								  @foreach ($engineTypes as $engineType)
									  
									  <option value="{{ $engineType->id }}" {{ $engineType->id == old('makeId') ? 'selected' : ''}}>
					    ...
					    <div id="collaps9" class="accordion-collapse collapse" aria-labelledby="heading9" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
						  	<form method="POST" action="{{ route('keyword-search') }}">
								...
								@csrf
								<label class="pb-2">Select Engine Capacity</label><br>
							  
								<select name="makeId" required>
									<option>Select</option>
								  @foreach ($engineSizes as $engineSize)
									  
									  <option value="{{ $engineSize->id }}" {{ $engineSize->id == old('makeId') ? 'selected' : ''}}>
					    ...
					    <div id="collaps10" class="accordion-collapse collapse" aria-labelledby="heading10" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
						  	<form method="POST" action="{{ route('keyword-search') }}">
								...
								@csrf
								<label class="pb-2">Select Body Type</label><br>
							  
								<select name="makeId" required>
									<option>Select</option>
								  @foreach ($carBodies as $carBody)
									  
									  <option value="{{ $carBody->id }}" {{ $carBody->id == old('makeId') ? 'selected' : ''}}>
					    ...
					    <div id="collaps11" class="accordion-collapse collapse" aria-labelledby="heading11" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
						  	<form method="POST" action="{{ route('keyword-search') }}">
								...
								@csrf
								<label class="pb-2">Select Color Family</label><br>
							  
								<select name="makeId" required>
									<option>Select</option>
								  @foreach ($carColors as $carColor)
									  
									  <option value="{{ $carColor->id }}" {{ $carColor->id == old('makeId') ? 'selected' : ''}}>
					    ...
					    <div id="collaps15" class="accordion-collapse collapse" aria-labelledby="heading15" data-bs-parent="#accordionFlushExample">
					      <div class="accordion-body">
						  	<form method="POST" action="{{ route('keyword-search') }}">
								...
								@csrf
								<label class="pb-2">Select Condition</label><br>
							  
								<select name="makeId" required>
									<option>Select</option>
								  @foreach ($carConditions as $carCondition)
									  
									  <option value="{{ $carCondition->id }}" {{ $carCondition->id == old('makeId') ? 'selected' : ''}}>
