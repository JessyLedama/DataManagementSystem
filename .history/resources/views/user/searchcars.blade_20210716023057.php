							...
							<div class="col-md-4">
								<div class="featured-item">
						    		<div class="f-image">
										...
										<div class="price-tag">
						    				<span>Kshs. {{ ucwords($car->price) }}<span style="font-size: 14px;font-weight: 400">({{ $car->priceType }})</span></span>
						    			</div>
							    	</div>
							    	@foreach($carMakes as $carMake)
									@if($car->makeId == $carMake->id && carModel)
									<div class="featured-content">
							    		<div class="category-title">
							    			<a href="#" class="padding-cats txt-hover">{{ $carMake->name }}</a>
							    		...
							    		<div class="featured-desc">
								    		...
								    		<p class="location"><i class="flaticon-maps-and-flags"></i> <a class="txt-hover" href="#">
												{{ ucwords($car->selleraddress) }}
											</a>
											</p>

								    		<ul>
								    			<li><i class="flaticon-petrol"></i> {{ ucwords($car->enginetypeId) }}</li>
