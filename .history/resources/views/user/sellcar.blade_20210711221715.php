          ...
          <div class="sellCar-form mb-5 p-4 bg-white pt-5">
            <form method="POST" action="{{ route('sell-car-store') }}" enctype="multipart/form-data">
              	...
              	<div class="row">
              		...
              		<div class="col-md-6">
						...
						<div class="mb-4">
							...
							<select class="form-control select2" name="conditionIds" required>
						...
						<div class="mb-4">
							...
							<select class="form-control select2" name="transmissionIds" required>
								@foreach ($conditionIds as $condition)
									<option>Select</option>
									<option value="{{ $condition->id }}" {{ $condition->id == old('conditionId') ? 'selected' : ''}}>
											{{ ucwords($condition->name) }}
				...
				<div class="mb-4">
                  ...
                  <input type="text" name="" placeholder="Search Location" class="form-control">
                </div>
