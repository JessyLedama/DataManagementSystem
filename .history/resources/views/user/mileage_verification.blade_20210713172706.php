                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <div class="mb-3">
                        ...
                        <label for="car_" class="form-label" :value="__('Registration')">Car Chasis Number</label>
                        
                        <input type="text" name="car_" placeholder="Car Chasis Number" class="form-control" id="car_" :value="old('car_')" required>
                      </div>
                    </div>
                  </div>
               </div>
