                ...
                <div class="mb-4">
                  ...
                  <input type="text" placeholder="Enter Title" class="form-control" id="title">
	              	...
	              	<label class="pb-2">Select Make 
	              		<span>Select suitable category for your ad  
									</span>
								</label>
              	...
              	<div class="row">
              		...
              		<div class="col-md-6">
		                  ...
		                  <input type="text" class="form-control">
										...
										<div class="mb-4">
			              	<label class="form-label pb-2">Type</label>
			                <select class="form-control select2">
			                   <option>Select</option> 
			                   <option>Sell</option>
			                </select>
			                ...
			                <select class="form-control select2">
			                   <option>Select</option> 
			                   <option>Body Type 1</option>
			                   <option>Body Type 2</option>
			                   <option>Body Type 3</option>
			                   <option>Body Type 4</option>
			                   <option>Body Type 5</option>
			                   <option>Body Type 6</option>
			                </select>
		              	</div>
