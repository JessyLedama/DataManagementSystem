...
class VehicleTransferController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.vehicle_transfer.create', compact('carMakes', 'engineCapacity', 'carTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('success', 'Your vehicle transfer request has been received! Our representative will get in touch with you soon.');
    ...
    {
        $updatedTransfer = VehicleTransfer::where('id', $vehicleTransfer)->update($request->all());

        session()->flash('success', 'Your vehicle transfer request has been updated! Our representative will get in touch with you soon.');
