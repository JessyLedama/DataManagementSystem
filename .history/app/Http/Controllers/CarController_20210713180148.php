...
class CarController extends Controller
{
    ...
    public function create()
    {
        ...
        $cities = Cities::all();
        $carPriceTypes = Cities::all();

        return view('user.sellcar', compact('carMakes', 'carModels', 'carBodies', 'engineSizes', 'colorIds', 'conditionIds', 'transmissionIds', 'engineTypeIds', 'cities'));
    }
