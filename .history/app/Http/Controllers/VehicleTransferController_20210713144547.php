...
class VehicleTransferController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.settings.vehicle_transfer.index', compact('vehicleTr'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $transfer = Car::where('name', $selectVehicle)->update([
        ...
        return view('admin.settings.vehicle_transfer.index', compact('newOwner', 'selectVehicle', 'transfer', 'cities'));
    }
