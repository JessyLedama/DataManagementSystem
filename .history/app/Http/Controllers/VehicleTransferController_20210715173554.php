...
class VehicleTransferController extends Controller
{
    ...
    public function create()
    {
        ...
        $carMakes = CarBody::all();

        $engineCapacity = EngineSize::all();

        return view('user.vehicle_transfer.create', compact('vehicles', 'carMakes', 'engineCapacity'));
    }
    ...
    public function edit(VehicleTransfer $vehicleTransfer)
    {
        ...
        return view('admin.settings.vehicle_transfer.edit', compact('vehicleTransferRequests'));
    }
