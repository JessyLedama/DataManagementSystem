...
class MileageVerificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.settings.mileage_verification.index', compact('mileageVerifications'));
    }
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('success', 'Your mileage verification request has been received!');
